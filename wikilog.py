...
WORDING = [
    ...
    ("മനുഷ്യമേൽനോട്ടത്തിൽ", "ഒരു ഉപയോക്താവിന്റെ മേൽനോട്ടത്തിൽ"),
]
...
def build(cfg):
    ...
    main = [
        ...
        "സഹായത്തോടെ, ഒരു ഉപയോക്താവിന്റെ മേൽനോട്ടത്തിൽ തയ്യാറാക്കിയത്.}}",
        ...
        "കോഡ് നടത്തുന്ന ഘടനാപരിശോധനയും ആശയപരിശോധനയും — "
        ...
        f"* {B}ആശയപരിശോധന — {S['verif']} ലേഖനങ്ങൾ{B} "
        f"({S['issues']} പ്രത്യേക പ്രശ്നങ്ങൾ, ശരാശരി ഒരു ലേഖനത്തിന് "
        f"{S['per']:.1f}). ഭാഷ മാത്രം മാറ്റിയോ, ആശയം മാറിയോ എന്ന് സ്വതന്ത്രമായ രണ്ടാമതൊരു AI "
